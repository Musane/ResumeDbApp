...
public class User implements Serializable {
    ...
    public User(Integer id, String name, String surname, String email, String phone, String profileDescription, Date birthdate, Country nationality, Country birthplace) {
        this.id = id;
        this.name = name;
        this.surname = surname;
        this.email = email;
    ...
    public void setBirthplaceId(Country birthplace) {
        this.birthplace = birthplace;
    }
